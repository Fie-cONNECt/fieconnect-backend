...
> = ResolversObject<{
  ...
  >;
  savePreferences?: Resolver<
    ResolversTypes['User'],
    ParentType,
    ContextType,
    RequireFields<MutationSavePreferencesArgs, 'input'>
  >;
  skipPreferences?: Resolver<
    ResolversTypes['User'],
    ParentType,
    ContextType,
    Partial<MutationSkipPreferencesArgs>
  >;
  ...
  >;
  trackPropertyView?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<MutationTrackPropertyViewArgs, 'propertyId'>
  >;
...
> = ResolversObject<{
  ...
  recommendedProperties?: Resolver<
    Array<ResolversTypes['RecommendedProperty']>,
    ParentType,
    ContextType,
    Partial<QueryRecommendedPropertiesArgs>
  >;
  tenancy?: Resolver<
...
export type RecommendedPropertyResolvers<
  ContextType = AuthContext,
  ParentType extends ResolversParentTypes['RecommendedProperty'] =
    ResolversParentTypes['RecommendedProperty'],
> = ResolversObject<{
  property?: Resolver<ResolversTypes['Property'], ParentType, ContextType>;
...
export type UserPreferencesResolvers<
  ContextType = AuthContext,
  ParentType extends ResolversParentTypes['UserPreferences'] =
    ResolversParentTypes['UserPreferences'],
> = ResolversObject<{
  amenities?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
